...
namespace Mohit\Stripe\Test\Unit\Model\Ui;
...
use Mohit\Stripe\Model\Ui\TokenUiComponentProvider;
...
class TokenUiComponentProviderTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * @covers \Mohit\Stripe\Model\Ui\TokenUiComponentProvider::getComponentForToken
     */
    public function testGetComponentForToken()
    {
        ...
        $params = [
            ...
            'name' => 'Mohit_Stripe/js/view/payment/method-renderer/vault'
        ];
